...
export const seoPages: Record<SeoPageKey, SeoPage> = {
  ...
  smallElectrical: { key: "smallElectrical", path: "/pienet-sahkotyot-helsinki", title: "Pienet sähkötyöt Helsinki | Ullanlinnan Sähkö", description: "Yksittäiset ja rajatut sähkötyöt Helsingissä. Lähetä työn kuvaus, kohteen osoite ja kuvat, jotta toteutettavuus voidaan arvioida.", breadcrumbLabel: "Pienet sähkötyöt Helsingissä", indexable: true, includeInSitemap: true },
